...
public class Cliente implements Serializable {
    ...
    public Cliente(Integer id, String nombre, String apellido, String email, String telefono, Double saldo) {
        this.id =  id;
        this.nombre = nombre;
    ...
    public String toString() {
        return "com.jsp.cc.model.Clientes[ id=" + id + " ]";
    }
